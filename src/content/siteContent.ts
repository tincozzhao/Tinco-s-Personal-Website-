...
export const siteContent: SiteContent = {
  ...
  chapters: [
    ...
    },
    {
      ...
      title: "CURIOSITY\nBECAME A\nCOMPASS",
      story:
        "Transitioning out of the pandemic, I learned to explore my opportunities as a student and creator online. In the process, I discovered a love for online creation as well as WEB Development and design, as well as activities like Dance and Stagecraft.",
      theme: "blue",
    ...
    },
    {
      ...
      yearLabel: "2026- FTC ROBOTICS REGIONALS",
      title: "IDEAS INTO\nTHINGS YOU\nCAN FEEL",
      story:
      ...
      highlights: ["Java", "Graphic Design", "Leadership"],
    },
    {
      id: "present",
      navLabel: "Contact",
      ...
      title: "THE NEXT\nCHAPTER IS\nOPEN",
      story:
        "I'm currently exploring new opportunities in content creation, and STEM fields. I'm excited to connect with like-minded individuals and collaborate on projects that make a positive impact.",
      theme: "ink",
      characterStage: "present",
      image: {
        label: "Renfaire 2026",
        path: "/renfaire.PNG",
        alt: "Photo of me at the Renfaire 2026 event, holding a sword.",
        aspectRatio: "4/5",
      },
      highlights: ["Digital Art", "AI Crowdfunding", "Machine Learning"],
    },
  ],
  projects: [
    {
    ...
    },
    {
      id: "project-three",
      number: "03",
      title: "FTC Robotics Gamma Rocks",
      summary: "Gamma Rocks 25735 is an all-girls FTC team based in Arcadia, California. We strive to innovate, investigate, and most importantly collaborate amongst the First Tech Challenge community.",
      role: "Team Captain & Lead Programmer",
      tools: ["Android Studio", "Java", "Robot Controller App"],
      outcome: "As a team captain and lead programmer, I led the team to design and program a robot for the 2026-2027 FTC season. We competed in regional competitions and advanced to state-level events, showcasing our skills in robotics and teamwork.",
      image: {
        label: "Robotics Team Photo",
        path: "/gamma.JPG",
  ...
  contact: {
    ...
    emailLabel: "zhaaot@gmail.com",
    socialLinks: ["Tinco Zhao on LinkedIn", "@4kanee_ on Instagram"],
  },
};
